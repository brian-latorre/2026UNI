...
$sym_plus   = $nbsp + $nbsp + "+" + $nbsp + $nbsp
$sym_minus  = $nbsp + $nbsp + [char]::ConvertFromUtf32(0x2013) + $nbsp + $nbsp
$sym_star   = $nbsp + $nbsp + [char]::ConvertFromUtf32(0x2605) + $nbsp + $nbsp
$sym_skull  = $nbsp + $nbsp + [char]::ConvertFromUtf32(0x2620) + $nbsp + $nbsp

$content = @"
**--- PRUEBA FINAL CON NBSP ---**
...
$temp = [System.IO.Path]::Combine([System.IO.Path]::GetTempPath(), "test_final_nbsp.json")
...
Write-Host "Prueba final NBSP enviada."
